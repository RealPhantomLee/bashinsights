    ...
    <section id="mission" className="section-clip-top bg-[var(--bg)]" aria-labelledby="mission-heading">
      <div className="accent-line mx-auto grid max-w-6xl gap-10 px-6 py-24 sm:py-28 md:grid-cols-[1fr_2fr] md:gap-16">
        <div className="flex flex-col gap-2">
          <p className="section-label scramble">01 / Mission</p>
        </div>
        <div className="flex flex-col gap-6">
          <h2
            id="mission-heading"
            className="word-split font-display text-3xl font-bold leading-snug text-[var(--fg)] sm:text-4xl"
          >
            BASH Insights exists to help agencies, institutions, and mission-driven partners solve complex challenges through practical solutions, trusted collaboration, and outcomes-focused support.
          </h2>
